    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              alt="ahmed salah portrait"
              width="200"
              height="200"
              quality="95"
              priority={true}
              className="h-60 w-56 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="/Ahmed_Salah_AboShendy_cv.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://linkedin.com/in/ahmed-salah-1b530b182"
          target="_blank"
        >
          <BsLinkedin />
        </a>
